...
const BaseFormFormaPagamentoExterno = ({carregando, error, handleSubmit, setAbaAtual, abaAtual, benfeficiario, atualizarFormaPagamento, gerarListEspecializacao, dateFormaPagamentoAtendimento, especializacao,
...
export default BaseFormFormaPagamentoExterno;