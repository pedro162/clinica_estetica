                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        <NavDropdown title="Financeiro" id="collasible-nav-dropdown">
                            ...
                            <NavDropdown.Item className={[estilos.itemMenu]} as='div' ><Link className={[estilos.link]} onClick={handleLinkClick} to="/financeiro/contas_receber/item" >Contas a receber itens</Link></NavDropdown.Item>
