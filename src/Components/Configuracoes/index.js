                            ...
                            <div class="col-md-4">
                                <div class="p-4 bg-light rounded shadow">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-2">
                                            <Link className={'text-primary text-decoration-underline'} to={'/vendedores/painel'}>Vendedores</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="p-4 bg-light rounded shadow">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li class="mb-2">
                                            <Link className={'text-primary text-decoration-underline'} to={'/financeiro/bandeiras-cartoes'}>Bandeiras de cartões</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
