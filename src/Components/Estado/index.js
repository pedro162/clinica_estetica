...
import { TOKEN_POST, CLIENT_ID, CLIENT_SECRET, ESTADO_ALL_POST, RECORD_NUMBER_PER_REQUEST } from '../../api/endpoints/geral.js'
...
const Estado = ({ defaultFilters, callBakSelectedItem, ignoreTableActions, ...props }) => {
