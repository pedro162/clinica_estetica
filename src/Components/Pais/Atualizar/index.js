...
const Atualizar = ({ idPais, setIdPais, callback, atualizarCadastro, setAtualizarCadastro }) => {
	...
	return (
		<>
			{!dataPais &&
				<Modal noBtnCancelar={true} noBtnConcluir={true} handleConcluir={() => null} title={'Atualizar Pais'} size="xs" propsConcluir={{}} labelConcluir={''} dialogClassName={''} aria-labelledby={'aria-labelledby'} labelCanelar="" show={setShowModalAtualizarPais} showHide={() => { setShowModalAtualizarPais(); }}>
					<Load />
				</Modal>
			}
			{dataPais &&
