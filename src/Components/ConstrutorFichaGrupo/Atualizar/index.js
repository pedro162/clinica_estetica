...
const Atualizar = ({idRegistro, setIdRegistro, callback, atualizarCadastro, setAtualizarCadastro})=>{
	...
	/*
		atualizarCadastro && 
                <Atualizar setCarregandoDadosGrupo={null} atualizarCadastro={setAtualizarCadastro} idRegistro={clientChoice} setDataRegistro={null} setShowModalCriarRegistro={setShowModalAtualizarRegistro} />
	*/
	//<Pesquisar idRegistro={idRegistro} setDataRegistro={setDataRegistro} setCarregandoDadosGrupo={setCarregando} />
	return(
		<>
			{! dataRegistro &&
