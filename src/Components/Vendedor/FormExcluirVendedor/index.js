...
import { TOKEN_POST, CLIENT_ID, CLIENT_SECRET, CONSULTA_SAVE_POST, CONSULTA_ALL_POST, RCA_DELETE_POST, CLIENTES_ALL_POST, PROFISSIONAIS_ALL_POST, PROFISSIONAL_DIAS_EXPEDIENTE_ALL_POST } from '../../../api/endpoints/geral.js'
import Details from '../Visualizar/details.js';


const FormExcluirVendedor = ({ dataVendedorChoice, setIdVendedor, idVendedor, showModalExcluirVendedor, setShowModalExcluirVendedor, callback, excluirVendedor, setExcluirVendedor, carregando }) => {
	...
	const sendData = async ({
		...
		const { url, options } = RCA_DELETE_POST(idVendedor, getToken());
	...
	const dataPlanotCancel = dataToFormExcluirVendedor();
					...
					carregando && carregando == true
						...
						(
							<>
								...
								<Details
									{...dataVendedorChoice}
									dataVendedorChoice={dataVendedorChoice}
								/>
...
export default FormExcluirVendedor;
