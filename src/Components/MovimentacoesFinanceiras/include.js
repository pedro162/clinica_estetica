...

                        {
                            ...
                            celBodyTableArr: [
                                ...
                                },
                                {
                                    ...
                                    label: atual?.tp_movimentacao == 'negativa' ? (FORMAT_MONEY(Math.abs(atual.vr_movimentacao))) : 0,
                                    propsRow: {},
                                    toSum: 1,
                                    isCoin: 1,
                                },
                                {
                                    ...
                                    label: atual?.tp_movimentacao == 'positiva' ? (FORMAT_MONEY(Math.abs(atual.vr_movimentacao))) : 0,
                                    propsRow: {},
                                    toSum: 1,
                                    isCoin: 1,
                                },
                                {
                                    ...
                                    label: FORMAT_MONEY(Math.abs(atual.vr_saldo)),
                                    propsRow: {},
                                    toSum: 1,
                                    isCoin: 1,
                                },
                            ...
                            celBodyTableArr: [
                                [
                                    ...
                                    },
                                    {
                                        ...
                                        label: FORMAT_MONEY(Math.abs(atual?.vr_movimentacao)),
                                        props: { style: { textAlign: 'left' }, md: '3', sm: '3', xs: '3' },
                                        toSum: 0,
                                        isCoin: 0,
                                    },
