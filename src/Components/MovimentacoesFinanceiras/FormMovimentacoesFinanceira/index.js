...
import estilos from './FormMovimentacoesFinanceira.module.css'
...
const FormMovimentacoesFinanceira = ({dataMovimentacoesFinanceiraChoice, setIdMovimentacoesFinanceira, idMovimentacoesFinanceira, showModalCriarMovimentacoesFinanceira, setShowModalCriarMovimentacoesFinanceira, callback, atualizarMovimentacoesFinanceira, setAtualizarMovimentacoesFinanceira, carregando})=>{
    ...
    const sendData = async ({
		...
		if(atualizarMovimentacoesFinanceira == true){
            const {url, options} = CONSULTA_UPDATE_POST(idMovimentacoesFinanceira, data, getToken());
            ...
            if(json){
                ...
                callback();
                setShowModalCriarMovimentacoesFinanceira();
	...
	const dataToFormMovimentacoesFinanceira = ()=>{
	...
	return(
		...
		<>
			 <Formik 
                ...
                initialValues={{...dataToFormMovimentacoesFinanceira()}}
                validate={
                    values=>{
						...
						if(! atualizarMovimentacoesFinanceira){
            ...
            >
                {
                    (
						...
						<Modal  handleConcluir={()=>{handleSubmit(); }}  title={ (atualizarMovimentacoesFinanceira == true ? 'Atualizar' : 'Cadastrar')+' Atendimento'} size="lg" propsConcluir={{'disabled':loading}} labelConcluir={loading ? 'Salvando...' : 'Concluir'} dialogClassName={''} aria-labelledby={'aria-labelledby'} labelCanelar="Fechar" show={showModalCriarMovimentacoesFinanceira} showHide={()=>{setShowModalCriarMovimentacoesFinanceira();setAtualizarMovimentacoesFinanceira(false);setIdMovimentacoesFinanceira(null);}}>
							{
																		...
																		data={
																			{
																				...
																				options:[{label:'Selecione...',valor:'',props:{selected:'selected', disabled:'disabled'}},{label:'Procedimento',valor:'procedimento',props:{}},{label:'Avaliacao',valor:'avaliacao',props:{}},{label:'MovimentacoesFinanceira',valor:'consulta',props:{}},{label:'Retorno',valor:'retorno',props:{}}],
																				atributsContainer:{
																					className:''
																				}
																			}
																		...
																		data={
																			{
																				...
																				options:[{label:'Selecione...',valor:'',props:{selected:'selected', disabled:'disabled'}},{label:'Serviço',valor:'servico',props:{}},{label:'Avaliacao',valor:'avaliacao',props:{}},{label:'MovimentacoesFinanceira',valor:'consulta',props:{}},{label:'Retorno',valor:'retorno',props:{}}],
																				atributsContainer:{
																					className:''
																				}
																			}
...
export default FormMovimentacoesFinanceira;
