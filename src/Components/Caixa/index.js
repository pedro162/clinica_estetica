...
const Caixa = (props)=>{
    ...
    return (
        <>
            ...
            <Modal handleConcluir={()=>{alert('cloncluiu');setShowModalCriarCaixa(); }} children={<Create/>} title={'Cadastrar caixa'} size="lg" labelConcluir="Concluir" dialogClassName={'modal-90w'} aria-labelledby={'aria-labelledby'} labelCanelar="Fechar" show={showModalCriarCaixa} showHide={setShowModalCriarCaixa}/>
        </>
    )
}
