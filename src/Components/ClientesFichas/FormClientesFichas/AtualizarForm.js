...
const AtualizarForm = ({dataClientesFichasChoice, setDataClientesFichas, setIdClientesFichas, idClientesFichas, showModalCriarClientesFichas, setShowModalCriarClientesFichas, callback, atualizarClientesFichas, setAtualizarClientesFichas, carregando})=>{
            ...
            >
                {
                    (
						...
						<Modal  handleConcluir={()=>{handleSubmit(); }}  title={ (atualizarClientesFichas == true ? 'Atualizar' : 'Cadastrar')+' Ordem de Servico'} size="lg" propsConcluir={{'disabled':loading}} labelConcluir={loading ? 'Salvando...' : 'Concluir'} dialogClassName={'modal-90w'} aria-labelledby={'aria-labelledby'} labelCanelar="Fechar" show={showModalCriarClientesFichas} showHide={()=>{setShowModalCriarClientesFichas();setAtualizarClientesFichas(false);setIdClientesFichas(null);}}>
							{
										...
										<form onSubmit={handleSubmit}>
											...
											<Row className="my-3 mt-5">
												<Col xs="12" sm="12" md="12">
													...
													idClientesFichas={idClientesFichas}
