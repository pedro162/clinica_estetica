...
const FinalizarForm = ({dataClientesFichasChoice, setDataClientesFichas, setIdClientesFichas, idClientesFichas, showModalCriarClientesFichas, setShowModalCriarClientesFichas, callback, FinalizarClientesFichas, setFinalizarClientesFichas, carregando})=>{
    ...
    const sendData = async ({
		...
		const {url, options} = ORDEM_SERVICO_FINALIZAR_PROCEDIMENTO_POST(idClientesFichas, data, getToken());
            ...
            >
                {
                    (
						...
						<Modal  handleConcluir={()=>{handleSubmit(); }}  title={ (FinalizarClientesFichas == true ? 'Finalizar' : 'Cadastrar')+' Ordem de Servico'} size="xs" dialogClassName={null} propsConcluir={{'disabled':loading}} labelConcluir={loading ? 'Salvando...' : 'Concluir'} aria-labelledby={'aria-labelledby'} labelCanelar="Fechar" show={showModalCriarClientesFichas} showHide={()=>{setShowModalCriarClientesFichas();setFinalizarClientesFichas(false);setIdClientesFichas(null);}}>
							{
