			...
			>
				{
					(
						...
						<Modal handleConcluir={() => { handleSubmit(); }} title={'Cancelar Ordem de Servico'} size="xs" dialogClassName={'modal-os-fullscreen-mobile'} propsConcluir={{ 'disabled': loading }} labelConcluir={loading ? 'Salvando...' : 'Concluir'} aria-labelledby={'aria-labelledby'} labelCanelar="Fechar" show={showModalCriarOrdemServico} showHide={() => { setShowModalCriarOrdemServico(); setCancelarOrdemServico(false); setIdOrdemServico(null); }}>
							{
