...
const Finalizar = ({ idOrdemServico, setIdOrdemServico, callback, atualizarOrdemServico, setFinalizarOrdemServico }) => {
	...
	*/
	...
	return (
		<>
			{!dataOrdemServico &&
				<Modal noBtnFinalizar={true} noBtnConcluir={true} handleConcluir={() => null} title={'Finalizar OrdemServico'} size="xs" propsConcluir={{}} labelConcluir={''} dialogClassName={'modal-os-fullscreen-mobile'} aria-labelledby={'aria-labelledby'} labelCanelar="" show={setShowModalFinalizarOrdemServico} showHide={() => { setShowModalFinalizarOrdemServico(); }}>
					<Load />
				</Modal>
			}
