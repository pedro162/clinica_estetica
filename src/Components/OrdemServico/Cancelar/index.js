...
const Cancelar = ({ idOrdemServico, setIdOrdemServico, callback, atualizarOrdemServico, setCancelarOrdemServico }) => {
	...
	*/
	...
	return (
		<>
			{!dataOrdemServico &&
				<Modal noBtnCancelar={true} noBtnConcluir={true} handleConcluir={() => null} title={'Cancelar OrdemServico'} size="xs" propsConcluir={{}} labelConcluir={''} dialogClassName={'modal-os-fullscreen-mobile'} aria-labelledby={'aria-labelledby'} labelCanelar="" show={setShowModalCancelarOrdemServico} showHide={() => { setShowModalCancelarOrdemServico(); }}>
					<Load />
				</Modal>
			}
