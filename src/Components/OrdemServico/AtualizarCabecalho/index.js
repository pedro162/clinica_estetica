...
const AtualizarCabecalho = ({ idOrdemServico, setIdOrdemServico, callback, atualizarOrdemServico, setAtualizarCabecalhoOrdemServico }) => {
	...
	*/
	...
	return (
		<>
			{!dataOrdemServico &&
				<Modal noBtnCancelar={true} noBtnConcluir={true} handleConcluir={() => null} title={'AtualizarCabecalho OrdemServico'} size="xs" propsConcluir={{}} labelConcluir={''} dialogClassName={'modal-os-fullscreen-mobile'} aria-labelledby={'aria-labelledby'} labelCanelar="" show={setShowModalAtualizarCabecalhoOrdemServico} showHide={() => { setShowModalAtualizarCabecalhoOrdemServico(); }}>
					<Load />
				</Modal>
			}
