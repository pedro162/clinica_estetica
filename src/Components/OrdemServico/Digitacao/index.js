...
const Digitacao = ({ idOrdemServico, setIdOrdemServico, callback, atualizarOrdemServico, setDigitacaoOrdemServico }) => {
	...
	*/
	...
	return (
		<>
			{!dataOrdemServico &&
				<Modal noBtnCancelar={true} noBtnConcluir={true} handleConcluir={() => null} title={'Digitacao OrdemServico'} size="xs" propsConcluir={{}} labelConcluir={''} dialogClassName={'modal-os-fullscreen-mobile'} aria-labelledby={'aria-labelledby'} labelCanelar="" show={setShowModalDigitacaoOrdemServico} showHide={() => { setShowModalDigitacaoOrdemServico(); }}>
					<Load />
				</Modal>
			}
