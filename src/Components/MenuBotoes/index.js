                                    ...
                                    return(
                                        <Col sm='4' xs='4' md='4' key={'MenuBotoes_'+index}  className={'my-2'} >
                                             <Link className={null}  to={url} style={{width:'100%', height:'100%'}} >
                                                <Button style={{alignItems: 'center', width: '100%', height: '80pt', color: '#FFF', backgroundColor: 'rgba(204, 204, 204, 0.2)', border: 'none', boxShadow:'2px 2px 4px #ddd', display: 'flex', flexDirection: 'column', alignItems: 'center', alignSelf: 'center' }}>
                                                    <span style={{fontSize:'32pt', marginTop: 'auto', color:'#74D4F2', opacity: '1 !important', fontWeight:'bolder'}} >{iconLabel}</span>
