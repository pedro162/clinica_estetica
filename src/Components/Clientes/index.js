...
const Clientes = ({ defaultFilters, callBakSelectedItem, ignoreTableActions, ...props }) => {
    ...
    const [documentoPessoa, setDocumentoPessoa] = React.useState(null)
    ...
    const handleDocumentFilter = ({ target }) => {
        setDocumentoPessoa(target.value.trim())
    }
    ...
    const filtersArr = [
        ...
        },
        {
            ...
            atributsFormLabel: {},
            atributsContainer: { xs: "8", sm: "8", md: "2", className: 'mb-2' },
            atributsFormControl: { 'type': 'text', size: "sm", 'name': 'documento', value: documentoPessoa, onChange: handleDocumentFilter, onBlur: handleDocumentFilter, onKeyUp: handleSearch },
    ...
    const montarFiltro = () => {
        ...
        if (documentoPessoa) {
            filtros['documento'] = documentoPessoa;
            detalhesFiltros['documento'] = {
                label: 'documento',
                value: documentoPessoa,
                resetFilter: () => { setDocumentoPessoa(''); removeFilter('documento') },
            };
        }
