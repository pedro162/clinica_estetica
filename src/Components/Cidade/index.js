...
import { TOKEN_POST, CLIENT_ID, CLIENT_SECRET, CIDADE_ALL_POST, RECORD_NUMBER_PER_REQUEST } from '../../api/endpoints/geral.js'
...
const Cidade = (props) => {
    ...
    const [qtdItemsPerPage, setQtdItemsPerPage] = React.useState(1)
    ...
    const requestAllCidade = async () => {
        ...
        let { url, options } = CIDADE_ALL_POST({ ...filtros }, getToken());
