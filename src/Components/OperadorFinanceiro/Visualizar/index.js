...
const Visualizar = ({ idOperadorFinanceiro, setIdOperadorFinanceiro, callback, atualizarOperadorFinanceiro, setVisualizarOperadorFinanceiro }) => {

	const [showModalVisualizarOperadorFinanceiro, setShowModalOperadorFinanceiro] = React.useState(false)
	...
	return (
		<>
			{!dataOperadorFinanceiro &&
				<Modal noBtnCancelar={true} noBtnConcluir={true} handleConcluir={() => null} title={'Visualizar Operador Financeiro'} size="xs" propsConcluir={{}} labelConcluir={''} dialogClassName={''} aria-labelledby={'aria-labelledby'} labelCanelar="" show={true} showHide={() => { setShowModalOperadorFinanceiro(); }}>
					<Load />
				</Modal>
			}
			...
			{dataOperadorFinanceiro &&
				<Modal
					...
					labelCanelar="Fechar"
					show={showModalVisualizarOperadorFinanceiro}
					showHide={() => { setShowModalOperadorFinanceiro(false); setVisualizarOperadorFinanceiro(false); setIdOperadorFinanceiro(null) }}
