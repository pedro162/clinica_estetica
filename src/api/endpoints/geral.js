...
const SANDBOX = false;
const BASE_URL =  (SANDBOX === true) ? "http://1.josepedro.tmp.k8.com.br/api" : 'http://192.168.100.5:8081';///api//http://192.168.100.5:3000/ //O laravel tem que roda no http://192.168.100.5:8081
