...
export const CAIXA_ALL_POST = (data, token) => {
    ...
    return {
        url: BASE_URL + '/api/caixa/json',
        options: myInit
    }

}
export const CAIXA_ONE_GET = (id, token) => {
    ...
    return {
        url: BASE_URL + '/api/caixa/info/' + id,
        options: myInit
    }

}

export const CAIXA_SAVE_POST = (data, token) => {
    ...
    return {
        url: BASE_URL + '/api/caixa/store',
        options: myInit
    }

}

export const CAIXA_UPDATE_POST = (id, data, token) => {
    ...
    return {
        url: BASE_URL + '/api/caixa/update/' + id,
        options: myInit
    }

}

export const CAIXA_DELETE_POST = (id, token) => {
    ...
    return {
        url: BASE_URL + '/api/caixa/destroy/' + id,
        options: myInit
    }
...
export const NOTIFICATION_ALL_POST = (data, token) => {
    ...
    return {
        url: BASE_URL + '/api/notification/json',
        options: myInit
    }
...
export const NOTIFICATION_ONE_GET = (id, token) => {
    ...
    return {
        url: BASE_URL + '/api/notification/info/' + id,
        options: myInit
    }

}

export const NOTIFICATION_SAVE_POST = (data, token) => {
    ...
    return {
        url: BASE_URL + '/api/notification/store',
        options: myInit
    }
...
export const NOTIFICATION_EMAIL_SAVE_POST = (data, token) => {
    ...
    return {
        url: BASE_URL + '/api/notification/email/store',
        options: myInit
    }
...
export const NOTIFICATION_WHATSAPP_SAVE_POST = (data, token) => {
    ...
    return {
        url: BASE_URL + '/api/notification/whatsapp/store',
        options: myInit
    }

}

export const NOTIFICATION_UPDATE_POST = (id, data, token) => {
    ...
    return {
        url: BASE_URL + '/api/notification/update/' + id,
        options: myInit
    }

}

export const NOTIFICATION_DELETE_POST = (id, token) => {
    ...
    return {
        url: BASE_URL + '/api/notification/destroy/' + id,
        options: myInit
    }
...
export const WIDGET_FAT_LIQUIDEZ_FILIAL_ALL_POST = (data, token) => {
    ...
    return {
        url: BASE_URL + '/api/widget/faturamento/liquidez/filial/json/&widget=faturamento_liquidez_filial',
        options: myInit
    }
...
//--- Widget faturamento liquidez por filial  ----------------------------------
export const WIDGET_ATENDIMENTOS_TIPOS_ALL_POST = (data, token) => {
    ...
    return {
        url: BASE_URL + '/api/widget/atendimento/qtd/json/&widget=atendimento_por_tipo',
        options: myInit
    }
